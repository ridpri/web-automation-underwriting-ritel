export const PROPERTY_PRODUCT_VARIANTS = {
  ...
  "property-all-risk": {
    ...
    heroSubtitle:
      "Perlindungan menyeluruh untuk bangunan, inventaris, dan isi properti dari risiko kerusakan fisik yang mendadak, dengan perluasan yang bisa dipilih sesuai kebutuhan.",
    catalogSubtitle: "Perlindungan untuk bangunan dan isi properti terhadap kerusakan fisik tak terduga.",
    catalogDescription: "Perlindungan menyeluruh untuk bangunan, inventaris, dan isi properti dari kerusakan fisik mendadak, dengan perluasan yang bisa dipilih sesuai kebutuhan.",
    ...
    policyDocumentName: "Wording Asuransi Properti All Risk",
