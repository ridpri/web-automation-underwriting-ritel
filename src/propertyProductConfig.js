export const PROPERTY_PRODUCT_VARIANTS = {
  "property-safe": {
    ...
    shareSubject: "Penawaran Asuransi Properti - Kebakaran",
    shareLabel: "Asuransi Properti - Kebakaran",
    paymentSuccessMessage: "Pembayaran Asuransi Properti - Kebakaran berhasil disimulasikan.",
  ...
  "property-all-risk": {
    ...
    heroSubtitle:
      "Perlindungan untuk bangunan dan isi properti terhadap kerusakan fisik mendadak, dengan tambahan perlindungan yang bisa dipilih sesuai kebutuhan.",
    catalogSubtitle: "Perlindungan untuk bangunan dan isi properti dari risiko kerusakan fisik mendadak.",
    catalogDescription: "Perlindungan untuk bangunan, inventaris, dan isi properti dari kerusakan fisik mendadak, dengan tambahan perlindungan opsional.",
    catalogImage: "https://images.unsplash.com/photo-1460317442991-0ec209397118?auto=format&fit=crop&w=900&q=80",
    productCode: "PAR",
    primaryCoverageTitle: "Jaminan Semua Risiko Harta Benda",
    primaryCoveragePremiumLabel: "Premi",
    primaryCoverageDescription:
      "Menjamin kerusakan fisik yang terjadi secara tiba-tiba dan tidak terduga pada bangunan, inventaris, dan isi properti yang diasuransikan sesuai Polis Semua Risiko Harta Benda, sepanjang tidak termasuk dalam pengecualian polis.",
    primaryCoverageDeductibleClassOne: "Risiko sendiri mengikuti nilai deductible yang tercantum dalam ikhtisar polis.",
    primaryCoverageDeductibleOther: "Risiko sendiri mengikuti nilai deductible yang tercantum dalam ikhtisar polis.",
    insuredRisksSectionTitle: "Jaminan Utama",
    exclusionsSectionTitle: "",
    exclusionsSectionSubtitle: "",
    importantExclusions: [],
    benefitsSummaryIntro:
      "Perlindungan utama mencakup kerusakan fisik mendadak pada bangunan dan isi properti sesuai jenis bangunan dan nilai yang ingin Anda lindungi.",
    summaryCoverageLine: "Tambahan perlindungan yang tersedia dapat dipilih untuk melengkapi proteksi properti Anda.",
    optionalExtensionsLabel: "Tambahan perlindungan yang tersedia",
    shareSubject: "Penawaran Asuransi Properti - All Risk",
    shareLabel: "Asuransi Properti - All Risk",
    paymentSuccessMessage: "Pembayaran Asuransi Properti - All Risk berhasil disimulasikan.",
    policyDocumentName: "Polis Semua Risiko Harta Benda",
