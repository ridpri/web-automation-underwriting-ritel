...
export default function PropertyStepOneFrontendCompact({
  ...
  const basePremiumNumber = Math.max(Math.round(totalValue * baseRate), 150000);
  const stampDutyNumber = 10000 + (selectedGuarantees.earthquake ? 10000 : 0);
  ...
  const estimatedTotalNumber = basePremiumNumber + additionalPremiumNumber + stampDutyNumber;
            ...
            <div className="mx-auto max-w-[1280px] px-4 md:px-6">
              <div className="mt-6 grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
                ...
                <SummarySidebarShell title="Ringkasan">
                  ...
                  <div className="border-t border-white/15 pt-3">
                    <SummaryRow label={activeVariant.primaryCoveragePremiumLabel} value={"Rp " + formatRupiah(basePremiumNumber)} />
                    {additionalPremiumNumber > 0 ? <SummaryRow label="Premi Tambahan Perlindungan" value={"Rp " + formatRupiah(additionalPremiumNumber)} /> : null}
                    <SummaryRow label="Biaya Materai" value={"Rp " + formatRupiah(stampDutyNumber)} />
                  </div>
