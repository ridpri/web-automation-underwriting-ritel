...
function SummarySidebarShell({ title = "Ringkasan", children }) {
  return (
    <aside className="h-fit self-start rounded-2xl bg-[#0A4D82] p-4 text-white shadow-lg md:sticky md:top-24">
    ...
    <div className="min-h-screen bg-[#F3F5F7] text-slate-900">
      ...
      <div className="mx-auto max-w-[1280px] px-4 py-8 md:px-6">
        ...
        title="Foto Properti"
          ...
          <aside className="h-fit self-start rounded-[28px] bg-[#0A4D82] p-5 text-white shadow-[0_24px_60px_rgba(10,77,130,0.32)] md:sticky md:top-24">
